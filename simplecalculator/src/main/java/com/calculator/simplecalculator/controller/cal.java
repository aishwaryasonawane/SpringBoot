...
public class cal {
	...
	{
		return "<h2> The sum is"+cal_logic.addNO(n1, n2)+"</h2>";//call CalculatorLogic class addNO()method
	}
	...
	public String calculate1(@RequestParam(value="n1",required=true,defaultValue="1")int n1,
			@RequestParam(value="n2",required=true,defaultValue="2")int n2) //It is a calculate method use for the take parameter
	{
		return "<h2> The substraction is"+cal_logic.subNO(n1, n2)+"</h2>";//call CalculatorLogic class subNO()method
	}
	...
	public String calculate3(@RequestParam(value="n1",required=true,defaultValue="1")int n1,
			@RequestParam(value="n2",required=true,defaultValue="2")int n2) //It is a calculate method use for the take parameter
	{
		return "<h2> The multiplication is"+cal_logic.mulNO(n1, n2)+"</h2>";//call CalculatorLogic class mulNO()method
	}
	...
	public String calculate4(@RequestParam(value="n1",required=true,defaultValue="1")int n1,
			@RequestParam(value="n2",required=true,defaultValue="2")int n2)//It is a calculate method use for the take parameter
	{
		return "<h2> The division is"+cal_logic.divNO(n1, n2)+"</h2>";//call CalculatorLogic class divNO()method
	}
